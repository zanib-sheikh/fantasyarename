...
>
  {/* Main Heading */}
  <h1
    className={`lg:text-4xl text-4xl  font-extrabold text-[#3C6D00] mb-4 ${
  ...
  {/* Button */}
<button
  className={`mt-6 lg:mt-16 flex mx-auto lg:mx-0 items-center  px-6 py-2 bg-white hover:bg-gray-200 hover:text-black border-2 border-b-4 border-black rounded-full text-gray-900 font-semibold text-sm shadow-lg transition duration-300 ${
    ...
    {t("scoringSystem.leagueInfo")}
      ...
      <div className="flex-1 p-8 order-2 lg:order-1 bg-[rgb(7,7,7)]">
        ...
        <div className="flex flex-wrap gap-0 text-gray-300">
          ...
          {/* Right Column: Points */}
<div
  className={`w-0 lg:w-1/2 mt-2 text-center ${
    i18n.language === "ar" ? "pr-14 lg:pr-0" : "pr-12 lg:pr-0"
  }`}
>
  <ul className="space-y-2">
...
<div id="subscription" className="flex flex-col items-center  text-center w-full my-8">
  <section dir={i18n.language === "ar" ? "ltr" : "ltr"} className="flex flex-col items-center px-11 w-full">
    ...
    <div className="lg:hidden overflow-auto flex w-full px-0">
  <div className="flex gap-2" id="carousel">
    {/* Silver Tier */}
